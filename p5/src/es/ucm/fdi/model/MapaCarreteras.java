...
public class MapaCarreteras {
	...
	public MapaCarreteras() {
		...
		public void addCruce(String idCruce, CruceGenerico<?> cruceGenerico) throws ErrorEventoAñadido {
		// comprueba que “idCruce” no existe en el mapa.
		if(this.mapaDeCruces.containsKey(cruceGenerico)) 
			throw new ErrorEventoAñadido("Cruce  ya añadido");
		else
			this.cruces.add(cruceGenerico);
			this.mapaDeCruces.put(idCruce, cruceGenerico);
		...
		public String generateReport(int time) {
		   ...
		   public CruceGenerico<?>  getCruce(String id) throws ErrorBusquedaMapa {
